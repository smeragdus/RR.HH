...
record UserRequest(@Email @NotBlank String email, String password, @NotNull Role role, AccountStatus status, Long employeeId) {}
...
record AbsenceRequestCreate(@NotNull RequestType type, @NotNull LocalDate startDate, @NotNull LocalDate endDate, @NotBlank String reason, Long employeeId) {}
...
record ContractRequest(@NotNull Long employeeId, @NotBlank String contractType, @NotNull LocalDate startDate, LocalDate endDate, ContractStatus status) {}
